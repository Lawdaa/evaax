...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        if message.chat.id in temp.BANNED_CHATS:
            ...
            buttons = [[
                InlineKeyboardButton('Support', url=f'https://t.me/CreatorPavanSupport')
            ]]
            ...
            return
        buttons = [[
            InlineKeyboardButton('ℹ️ Help', url=f"https://t.me/CreatorPavanSupport"),
            InlineKeyboardButton('📢 Updates', url='https://t.me/TheCreatorPavan')
        ]]
        reply_markup=InlineKeyboardMarkup(buttons)
